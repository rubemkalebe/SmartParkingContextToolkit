...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.setProperty("java.net.preferIPv4Stack", "true"); // Rubem: no meu
																// só executa
																// setando isso
		Discoverer.start();
		...
		do {
			...
			case 2:// Solicitar entrada no estacionamento
				...
				// vehicles.get(v1).newVehicleWidget.NEW_VEHICLE =
				// vehicles.get(v1).id;
				// vehicles.get(v1).newVehicleWidget.updateData(NewVehicleWidget.NEW_VEHICLE,
				// true);
